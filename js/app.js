 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".share__slider")) new core(".share__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                ...
                loop: true,
                navigation: {
                    prevEl: ".share__prev-btn",
                    nextEl: ".share__next-btn"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
        ...
        class ScrollWatcher {
            ...
            scrollWatcherRun() {
                ...
                this.scrollWatcherConstructor(document.querySelectorAll("[data-watch-once]"));
            }
            ...
            getScrollWatcherConfig(paramsWatch) {
                ...
                if (paramsWatch.margin.indexOf("px") < 0 && paramsWatch.margin.indexOf("%") < 0) {
                    this.scrollWatcherLogging(`йой, налаштування  data-watch-once-margin потрібно задавати в PX або %`);
                    return;
                }
            ...
            scrollWatcherCallback(entry, observer) {
                ...
                targetElement.hasAttribute(" data-watch-oncedata-watch-once") && entry.isIntersecting ? this.scrollWatcherOff(targetElement, observer) : null;
